...
class Reply extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('content, userId, createDate, commentId', 'required'),
			array('userId, commentId', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, content, userId, createDate, commentId', 'safe', 'on'=>'search'),
		);
	}
