			...
			<div class="container-fluid">
				...
				<div class="nav-collapse">
					<?php $this->widget('zii.widgets.CMenu',array(
						...
						'items'=>array(
        array('label'=>'Wrasks', 'url'=>array('/post/post/admin'), 'visible'=>!Yii::app()->user->isGuest),
	  ...
	  <div class="container">
		<div class="row">
			...
			<div id="footer-terms" class="col-md-6">
				© 2014-15 Wrask it. Developed by <a href="3eplc.com" target="_blank">3E IT Solutions</a>.
			</div> <!-- /.span6 -->
		 </div> <!-- /row -->
	  </div> <!-- /container -->
	</div>
